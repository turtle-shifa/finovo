...
class CompanyController extends Controller
{
    ...
    public function edit()
    {
        ...
        if (!$company) {
            return redirect('/dashboard')->with('error', 'No company profile found. Please create one first.');
        }
    ...
    public function update(Request $request)
    {
        ...
        if (!$company) {
            return redirect('/dashboard')->with('error', 'No company profile found.');
        }
        ...
        return redirect('/settings')->with('success', 'Company information updated successfully.');
    }
}
